...
nav:
  order: 1
  tooltip: FABILIS Research
---

# {% include icon.html icon="fa-solid fa-wrench" %}FABILIS Research
...
2. **High‑throughput material removal:** Investigate multiplex arrays of ILIS for scalable processing and faster material removal.

3. **Focused Ion Beams (FIB) based on ILIS:** Design and construct a bespoke focusing column for ILIS beams and implement it in an existing FIB system.

4. **Deposition:** At sufficiently low beam energy, deposit thin films of ionic liquids to study ionic liquid interfaces and surface phenomena.
